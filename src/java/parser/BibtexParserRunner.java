 ...
 */
public class BibtexParserRunner {
    /**
     ...
     */
    public static BibtexBibliography run(String[] args) {
        ...
        if (cmd.hasOption("sign")) {
            visitor = new BibtexPrintingVisitor(cmd.getOptionValue("sign").charAt(0), 40, 80);
        } else {
